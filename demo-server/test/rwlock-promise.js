/* Since rwlock-promise is just a wrapper around rwlock, this test code is taken
 * from the rwlock project directly (https://github.com/71104/rwlock/blob/master/test/all.js),
 * and was modified to expect promises.
 */
var ReadWriteLock = require('../lib/rwlock-promise.js');

describe('rwlock-promise', function() {
